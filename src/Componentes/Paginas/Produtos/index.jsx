...
const subFiltros = [ 
    ...
    {
        nome: "Flores de corte",
        filter: "flores-de-corte"
    }, {
        nome: "Flores de vaso",
        filter: "flores-de-vaso"
    }, 
    {
        nome: "Plantas ornamentais",
        filter: "plantas-ornamentais"
    },
    {
        nome: "Plantas frutíferas",
        filter: "plantas-frutiferas"
    },

    {
        nome: "Árvore nativas",
        filter: "arvores-nativas"
    },

    {
        nome: "Vasos vietnamitas",
        filter: "vasos-vietnamitas"
    }, 
    {
        nome: "Vasos de fibras",
        filter: "vasos-de-fibra"
    },
    {
        nome: "Vasos de cimento", 
        filter: "vasos-de-cimento"
    },
    {
        nome: "Vasos de cerâmica",
        filter: "vasos-de-ceramica"
    },
    {
        nome: "Caxipos diversos",
        filter: "caxipos-diversos"
    }
]
            ...
            <ConteudoGeral>
                ...
                <section>
                    <article>
                        ...
                        <main>
                            {subFiltros.slice(0,6).map((subFiltro) => (
                                <SubFiltro 
                                    key={subFiltro.nome} 
                                    nome={subFiltro.nome} 
                        ...
                        <h3>Vasos</h3>
                        <main>
                            {subFiltros.slice(6).map((subFiltro) => (
                                <SubFiltro 
                                    key={subFiltro.nome} 
                                    nome={subFiltro.nome} 
                                    onSelect={handleSubFiltroSelect}
